...
**CEO & Founder @ Grupo CSV**

Médico Executivo e Consultor em Saúde. Atua na interseção entre liderança executiva, negócios, saúde baseada em valor (VBHC) e inovação.
...
Fundador do **Grupo CSV (Cuidados em Saúde com Valor)**, liderando as iniciativas:
*   **AxiaCare®:** Gestão e Governança Clínica.
*   **TheraTech®:** Tecnologia e Inteligência de Dados.
*   **MedValor®:** Educação Executiva em Saúde.

> "Meu propósito é promover inovação, excelência operacional e valor sustentável para pacientes, organizações e sociedade."
